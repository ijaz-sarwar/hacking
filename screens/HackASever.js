...
import HackAServer_Button from '../components/HackAServer_Button';
...
Processing triggers for man-db (2.8.7-3) ...{"\n"}  
          ...
          else if(text.includes("connect .server")) {
            children = <Text style={styles.txxt}>
            ...
            getting  the scripts ... {"\n"}  
             no pings detected {"\n"}  
              ...
              else if(text.includes("search for doors")) {
                children = <Text style={styles.txxt}>
                   checking exploits  {"\n"}  
                 ...
                 this.adds_show()
                  ...
                  else if(text.includes("mfs_trk in this.server")) {
                    children = <Text style={styles.txxt}>
                   attacking the server ...   {"\n"}  
                   loading the exploit ...    {"\n"}  
                   running the compiled scripts ... {"\n"}  
                   backdoor is being made ... {"\n"}  
                   scripts are running low due to poor connection ...   {"\n"}  
                   loaded in the server now ready to deploy the patch ...  {"\n"}  
